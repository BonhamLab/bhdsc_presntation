...
# ╔═╡ aabd5eb5-01bf-4ea0-94b0-c51070943feb
using PlutoUI
...
# ╔═╡ f2bec279-4ebd-4f0e-9547-c12e2c93068c
#logrange(start,stepmul,length) = start .* stepmul .^ (0:(length-1))

# ╔═╡ 62eb273a-bba1-4cef-9493-4980f6e88cf4
#@bind x Slider(logrange(10,10,6); show_value=true)
